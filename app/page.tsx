          ...
          {[1, 2, 3, 4, 5].map((d) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <p style={{ fontWeight: 700, fontSize: 15, color: m.color }}>{m.sub}</p>
    ...
    <div className="page-wrap min-h-screen">
      ...
      <div style={{
        ...
        <div>
          ...
          <h1 style={{ fontSize: 22, fontWeight: 700, color: "var(--text)", letterSpacing: "-0.3px", marginTop: 2 }}>
            {petName}と練習しよう
          </h1>
        </div>
        <div style={{
          ...
          <span style={{ fontSize: 13, fontWeight: 700, color: streak > 0 ? "#EA580C" : "#9CA3AF" }}>{streak}日</span>
        </div>
      </div>
      ...
      <div style={{ padding: "16px 20px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: 14, fontWeight: 700, color: dm.color, marginTop: 2 }}>{dm.sub}</p>
          </div>
        ...
        {todayStats.total > 0 && (
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: 24, fontWeight: 700, color: "var(--text)", marginTop: 4 }}>
                {todayStats.correct}
            ...
            <div style={{
              ...
              <span style={{ fontSize: 16, fontWeight: 700, color: todayRate && todayRate >= 80 ? "#059669" : "#EA580C" }}>
                {todayRate}%
              </span>
            </div>
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: -8 }}>
          {buildMenu(difficulty).map((item) => (
            <Link key={item.href} href={item.href} style={{
              ...
              <p style={{ fontWeight: 700, fontSize: 14, color: "var(--text)" }}>{item.label}</p>
